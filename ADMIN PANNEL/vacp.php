...
<div class="wrapper">
    <div class="sidebar">
        ...
        <li id="li1"><a href="dashboard.php" id="D"><i class="fas fa-home"></i>Dashboard</a></li>
            ...
            <li id="li9" style="background-color: #594f8d;"><a href="vacp.php" id="VACP"><i class="fa-solid fa-eye"></i>View All Contacted People</a></li>
            <li><a href="../Admin Login/logout.php"><i class="fa-solid fa-power-off"></i>Logout</a></li>
        </ul> 
    </div>
    <div class="main_content">
        <div id="View_All_CP" style="display: flex;align-items: center;justify-content: center;">
         <iframe src="viewallcp.php" frameborder="0" style="height: 600px" width="90%"></iframe>
        </div>
    </div>
</div>
<?php
