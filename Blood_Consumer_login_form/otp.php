<?php
  ...
  if (!isset($_SESSION['loggedin']) || ($_SESSION['loggedin'] != true)) {
      header("location: Donor_LoginForm.php");
      exit;
  }
  ...
  if(isset($_POST['sub'])){
    ...
    if($otp == $_SESSION['otp']){
      $db->signup($_SESSION['name'],$_SESSION['email'],$_SESSION['phone'],$_SESSION['address'],$_SESSION['pin'], $_SESSION['blood_group'],$_SESSION['state'],$_SESSION['city'],$_SESSION['password'],$_SESSION['age']);
      session_unset();
      session_destroy();
